(function ($) {
  ...
  function portfolioMasonry() {
    var portfolio = $("#portfolio_masonry,.portfolio_gallery,.custom_mansory");
    if (portfolio.length) {
  ...
  $(document).ready(function () {
    // Function to handle click on video play button
    $(".popup-youtube").on("click", function () {
      var videoUrl = "assets/img/about/video.mp4";
      // Open the video in a popup using Magnific Popup
      $.magnificPopup.open({
        items: {
          src: videoUrl
        },
  ...
  /*-------------------------------------------------------------------------------
    View More button js
  -------------------------------------------------------------------------------*/
  const viewMoreButtons = document.querySelectorAll(".viewMore_BTN");
